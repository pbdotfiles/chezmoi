---
description: Adversarial code reviewer using GLM. Finds bugs, design flaws, security issues, and untested assumptions. In TWO-STEPS mode, sketches an independent approach before seeing the diff. In ONE-STEP mode, performs mental analysis before critiquing.
mode: subagent
