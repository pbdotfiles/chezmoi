---
description: Adversarial reviewer for implementation plans using Qwen 3.7 Max. Finds blind spots, architectural risks, untested assumptions, and feasibility issues. Builds an independent plan blind before comparing (TWO-STEPS), or mentally analyzes before critiquing (ONE-STEP).
mode: subagent
